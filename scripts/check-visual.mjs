 ...
 *     passed (no missing report, no unexpected/flaky results).
 *
 * Run after `playwright test`, which writes playwright-report/results.json.
 */
import { existsSync, readFileSync, readdirSync, statSync } from 'node:fs';
import { join, relative } from 'node:path';
import { VIEWS, visualMatrix } from './lib/pages.mjs';
...
// would overwrite one baseline and make the two halves below disagree.
